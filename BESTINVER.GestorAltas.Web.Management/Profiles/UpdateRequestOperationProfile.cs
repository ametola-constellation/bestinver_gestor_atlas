...
{
    public class UpdateRequestOperationProfile : Profile
    {
        public UpdateRequestOperationProfile() : base(nameof(UpdateRequestOperationProfile))
        {
            CreateMap<RequestProductOperation, UpdateRequestOperationModel>()
                ...
                .ForMember(x => x.MaxAmount, o => o.MapFrom(s => s.Product.AdultMax))
                .ForMember(x => x.MinAmount, o => o.MapFrom(s => s.Product.AdultMin))
                .ForMember(x => x.Importe, o => o.MapFrom(s => s.Operation.Amount.ToString()))
                .ForMember(x => x.MinAmount, o => o.MapFrom(s => s.Product.AdultMin))
                .ForMember(x => x.MaxAmount, o => o.MapFrom(s => s.Product.AdultMax))
                .ForMember(x => x.FondoRecibido, o => o.MapFrom(s => s.Operation.FundReceived.HasValue ? s.Operation.FundReceived.Value : false))
                .ForMember(x => x.FondoRecibidoFecha, o => o.MapFrom(s => s.Operation.FundReceivedDate.HasValue ? s.Operation.FundReceivedDate : DateTime.UtcNow));

            CreateMap<UpdateRequestOperationModel, RequestOperation>()
                ...
                .ForMember(x => x.FundReceived, o => o.MapFrom(s => s.FondoRecibido))
                .ForMember(x => x.FundReceivedDate, o => o.MapFrom(s => s.FondoRecibidoFecha));
        }
    }
}