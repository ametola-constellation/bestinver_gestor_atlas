...
namespace BESTINVER.GestorAltas.Web.Management.HealthChecks;
...
public class StartupAndReadyHealthCheck : IHealthCheck
{
    ...
    /// 
    /// </summary>
    /// <param name="authenticationTicketContext"></param>
    /// <param name="services"></param>
    /// <param name="provider"></param>
    /// <param name="logger"></param>
    /// <param name="httpContextAccessor"></param>        
    /// <param name="healthCheckService"></param>
    public StartupAndReadyHealthCheck(ApplicationDbContext applicationDbContext
        , IServiceCollection services, IServiceProvider provider
        , ILogger<StartupAndReadyHealthCheck> logger, IHttpContextAccessor httpContextAccessor
    ...
    {
        //Caliento la obtencion del modelo de DbContext
        _ = _applicationDbContext.Model;
